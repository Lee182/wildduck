...
WILDDUCK_COMMIT="53ae783488c164b6d590ab8bc488874776d9abe7"
...
WILDDUCK_HARAKA_COMMIT="60451370ce7a4729765532d18cff762775a18d21"
...
# fresh install
cd /var/opt
git clone --bare git://github.com/Lee182/haraka-plugin-wildduck.git
echo "#!/bin/bash
